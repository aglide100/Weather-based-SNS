...
협찬번호 goods_no
물품명 goods_name
교환권 수  goods_required_ticket_count
상품 수 goods_count
시작일자 goods_start_date
마감일자 goods_end_date
...
광고번호 ad_no
카테고리 category_code
노출횟수 ad_history ad_impre_count
광고비용 ad_history cost
결제수단 ad_history ad_paymethod
시작일자 ad_Stat
마감일자 ad_
*/
...
const AdminPage: React.FC<{}> = ({}) => {
  ...
  return (
    <div>
      <nav className="flex flex-row w-full h-screen px-4 text-gray-900 0border border-purple-90">
        {nav}
      </nav>

      <div className="flex flex-row bg-purple-900 w-64 h-screen px-4 tex-gray-900 0border border-purple-90">
